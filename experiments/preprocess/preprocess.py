...
if opt.dataset == 'diginetica':
    ...
    dataset = './datasets/Yoochoose/yoochoose-clicks.dat'
...
with open(dataset, "r") as f:
    ...
    curdate = None
    #for data in reader:
    for data in tqdm(reader, desc="Reading data", unit=" lines"):  # Add progress bar here    
...
for s in tqdm(list(sess_clicks), desc="Filtering sessions", unit=" sessions"):  # Add progress bar here
...
for s in tqdm(sess_clicks, desc="Counting item appearances", unit=" sequences"):  # Add progress bar here
    seq = sess_clicks[s]
    for iid in seq:
...
#for s in list(sess_clicks):
for s in tqdm(list(sess_clicks), desc="Filtering sequences", unit=" sequences"):  # Add progress bar here
...
#for _, date in dates:
for _, date in tqdm(dates, desc="Finding max date", unit=" dates"):  # Add progress bar here
    if maxdate < date:
        maxdate = date
...
def obtian_tra():
    ...
    for s, date in tqdm(tra_sess, desc="Processing training sequences", unit=" sequences"):  # Add progress bar here
...
def obtian_tes():
    ...
    for s, date in tqdm(tes_sess, desc="Processing test sequences", unit=" sequences"):  # Add progress bar here
        seq = sess_clicks[s]
        outseq = []
        for i in seq:
            if i in item_dict:
