...
class SessionGraph(Module):
    ...
    def compute_scores(self, seq_hidden, mask):
        ...
        b = self.embedding.weight[1:] # (n_nodes - 1) x d (except for the 0 index)
        # print('b: ' ,b)
        # print('b.transpose(1, 0): ' ,b.transpose(1, 0)) # d x (n_nodes-1)

        #print('incompute score self.embedding.weight:', self.embedding.weight)
...
def forward(model, i, data):
    ...
    return targets, model.compute_attention_score(seq_hidden, mask)
